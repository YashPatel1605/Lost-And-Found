		...
		<footer className="bg-[#061b33] text-gray-300 px-4 sm:px-6 md:px-12 py-10">
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
					{/* Brand */}
					<div>
						<h2 className="text-2xl font-bold text-white flex items-center gap-2">🔍 CampusFind</h2>
						<p className="mt-4 text-sm leading-relaxed text-gray-400">
							The official Lost & Found portal for your campus community. Helping students reconnect
							with their belongings since 2024.
						</p>
					</div>
					...
					<div className="grid grid-cols-2 gap-8">
						<div>
							...
							<ul className="space-y-2 text-sm">
								...
								<li>
									<Link to="/mypost" className="hover:text-white transition-colors">
										Dashboard
									</Link>
								</li>
							</ul>
