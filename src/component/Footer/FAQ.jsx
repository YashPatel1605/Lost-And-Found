          ...
          <div className="lg:sticky lg:top-8 space-y-6">
            <div className="rounded-3xl bg-slate-900 text-white p-8 shadow-lg">
              ...
              <p className="mt-4 text-slate-300 leading-7">
                Everything you need to know about reporting, claiming, and
          ...
          <div className="space-y-5">
            <div className="rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 shadow-sm">
              <div className="mb-6">
                ...
                <p className="mt-3 text-slate-600 leading-7">
                  These answers cover reporting found items, proving ownership,
                  editing reports, and general platform usage.
                </p>
              </div>
            ...
            <div className="rounded-3xl bg-gradient-to-r from-teal-700 to-teal-800 p-6 sm:p-8 text-white shadow-lg">
              ...
              <p className="mt-3 text-teal-50 leading-7 max-w-2xl">
                If your issue involves a disputed claim, sensitive item, or
                urgent recovery request, contact the support team with your item
                ID and report date.
              </p>
              <div className="mt-6">
                <button 
