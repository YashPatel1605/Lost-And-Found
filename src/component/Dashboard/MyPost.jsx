...
export default function MyPosts() {
  ...
  const getTypeBadge = (item) => {
    ...
    if (type === "CLAIM" || type === "CLAIMED") return { label: "CLAIM", className: "bg-blue-100 text-blue-700" };
                ...
                return (
                  <div key={item._id} className="bg-white rounded-xl shadow p-4 sm:p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <span className={`justify-self-end px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${displayStatus.className}`}>
                        {displayStatus.label}
                      </span>
                    </div>
