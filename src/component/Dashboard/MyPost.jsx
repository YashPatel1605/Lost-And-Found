                                ...
                                return (
                                    <div key={item._id} className="bg-white rounded-xl shadow p-4 sm:p-5 space-y-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <h2 className="font-semibold text-gray-800 text-base sm:text-lg wrap-break-words">
                                                {item.itemTitle || item.title || item.itemName || 'No Title'}
                                            </h2>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            <span className="text-gray-500">Type</span>
                                            <span
                                                className={`justify-self-end px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${typeBadge.className}`}
                                            >
                                                {typeBadge.label}
                                            </span>
