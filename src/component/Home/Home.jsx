...
export default function Home() {
	...
	useEffect(() => {
		...
		const fetchHomeData = async () => {
			try {
				...
				const [itemsRes, statsRes] = await Promise.all([getAllItems(), getDashboardStats()])
	...
	const handleHomeItemUpdate = async () => {
		try {
	...
	return (
		<>
			<LostSomething dashboardStats={dashboardStats} loading={loadingStats} />
			<SimpleEffective />
